...
<nav class="navbar navbar-expand-lg navbar-dark navbar-ocean shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="index.php">UMKM | Staff</a>
        ...
        <div class="collapse navbar-collapse" id="navbarAdmin">
            <ul class="navbar-nav me-auto ms-lg-4">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $menuAktif == 'produk_masuk' ? 'active' : ''; ?>" href="index.php?menu=produk_masuk">Transaksi Barang Masuk</a>
                </li>
                <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle <?= in_array($menuAktif, ['laporan_pembelian', 'grafik_pembelian', 'laporan_penjualan', 'laporan_produk']) ? 'active' : ''; ?>"
            href="#"
            id="navbarLaporan"
            role="button"
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarLaporan">
        <li>
            <a class="dropdown-item <?= $menuAktif == 'laporan_pembelian' ? 'active' : ''; ?>" href="index.php?menu=laporan_pembelian">
                Laporan Pembelian
            </a>
        </li>
                ...
                <li>
                    <a class="dropdown-item <?= $menuAktif == 'grafik_pembelian' ? 'active' : ''; ?>" href="index.php?menu=grafik_pembelian">
                        Grafik Pembelian
                    </a>
                </li>

                <li>
                    <a class="dropdown-item <?= $menuAktif == 'laporan_penjualan' ? 'active' : ''; ?>" href="index.php?menu=laporan_penjualan">
                        Laporan Penjualan
                    </a>
                </li>

                <li>
                    <a class="dropdown-item <?= $menuAktif == 'laporan_produk' ? 'active' : ''; ?>" href="index.php?menu=laporan_produk">
                        Laporan Produk
                    </a>
                </li>
            </ul>
