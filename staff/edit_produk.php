        ...
        <div class="card-body">
            ...
            <form action="update_produk.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <?php if (!empty($data['gambar']) && file_exists("../admin/uploads/" . $data['gambar'])): ?>
                        <img src="../admin/uploads/<?= htmlspecialchars($data['gambar']); ?>" class="table-img" alt="<?= htmlspecialchars($data['nama_produk']); ?>">
                    <?php else: ?>
